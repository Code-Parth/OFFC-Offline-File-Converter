...
import { HiOutlineDownload } from "react-icons/hi"; import Image from 'next/image';
        ...
        return (
            <div className="space-y-6">
                {actions.map((action: Action, i: any) => (
                    <div
                        key={i}
                        className="w-full py-4 space-y-2 lg:py-0 relative cursor-pointer rounded-xl border h-fit lg:h-20 px-4 lg:px-10 flex flex-wrap lg:flex-nowrap items-center text-white justify-between"
                    >
                        {!is_loaded && (
                    ...
                    <div className="space-y-4 text-gray-500">
                        {is_hover ? (
                            ...
                            <>
                                ...
                                <h3 className="text-center font-medium text-2xl text-grey">
                                    OR
                                </h3>
                                <button className="bg-[#5F53E9] rounded-lg flex justify-center mx-20 w-32 h-6 font-medium text-base text-white">
                                    <Link href="/">
                                        <Image
                                            alt="logo"
                                            className=" "
